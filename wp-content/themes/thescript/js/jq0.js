...
! function(e, t, n) {
    ...
    function u(e, n, r, o) {
        var a, i, l, u, f = "modernizr",
            d = s("div"),
            p = c();
        if (parseInt(r, 10))
            for (; r--;) l = s("div"), l.id = o ? o[r] : f + (r + 1), d.appendChild(l);
        return a = s("style"), a.type = "text/css", a.id = "s" + f, (p.fake ? p : d).appendChild(a), p.appendChild(d), a.styleSheet ? a.styleSheet.cssText = e : a.appendChild(t.createTextNode(e)), d.id = f, p.fake && (p.style.background = "", p.style.overflow = "hidden", u = x.style.overflow, x.style.overflow = "hidden", x.appendChild(p)), i = n(d, e), p.fake ? (p.parentNode.removeChild(p), x.style.overflow = u, x.offsetHeight) : d.parentNode.removeChild(d), !!i
    }
    ...
    function p(e, t, o, a) {
        ...
        for (var f, p, m, h, g, v = ["modernizr", "tspan", "samp"]; !k.style && v.length;) f = !0, k.modElem = s(v.shift()), k.style = k.modElem.style;
        for (m = e.length, p = 0; m > p; p++)
            if (h = e[p], g = k.style[h], i(h, "-") && (h = l(h)), k.style[h] !== n) {
    ...
    function g(e, t, n, o, a) {
        ...
        return r(t, "string") || r(t, "undefined") ? p(s, t, o, a) : (s = (e + " " + w.join(i + " ") + i).split(" "), h(s, t, n))
    }
    ...
    E.testAllProps = g, E.testAllProps = v, o(), a(y), delete E.addTest, delete E.addAsyncTest;
...
jQuery(document).ready(function($) {
    $(function() {
        $('.mh-header-nav').slicknav({
            prependTo: '.mh-header-nav-mobile',
            duration: 500,
            allowParentLinks: true
        });
        $('.mh-main-nav').slicknav({
            prependTo: '.mh-main-nav-wrap',
            duration: 500,
            allowParentLinks: true
        });
        $('.mh-footer-nav').slicknav({
            prependTo: '.mh-footer-nav-mobile',
            duration: 500,
            allowParentLinks: true
        });
    });
