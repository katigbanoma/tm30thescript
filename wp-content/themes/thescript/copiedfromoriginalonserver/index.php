                    ...
                    <div id="mh_magazine_youtube-2" class="mh-widget mh_magazine_youtube">
                        ...
                        <div class="mh-video-widget">
                            <div class="mh-video-container">
                                <iframe width="560" height="315" src="https://www.youtube.com/embed/GEB6-bZh5R4" frameborder="0" allowfullscreen></iframe>
                            </div>
                            <p style="font-size: 12px; font-weight:bold; padding-top: 5px; padding-bottom:5px;">
                                ...
                                <i class="fa fa-chevron-right" style="padding-top: 5px; padding-bottom:5px"></i>SARAKI We must continue to be first and foremost:
                            </a>
                            </p>
                        </div>
