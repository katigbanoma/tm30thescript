<?php
	...
	if($_SERVER["REQUEST_METHOD"]=="POST")
	{
		if(check_admin_referer( 'edit-menu_'.$comment_id, 'TS_Poll_Nonce' ))
		{
			...
			// Standart Poll
			$TotalSoft_Poll_1_MW = sanitize_text_field($_POST['TotalSoft_Poll_1_MW']); $TotalSoft_Poll_1_BW = sanitize_text_field($_POST['TotalSoft_Poll_1_BW']); $TotalSoft_Poll_1_BR = sanitize_text_field($_POST['TotalSoft_Poll_1_BR']); $TotalSoft_Poll_1_Q_FS = sanitize_text_field($_POST['TotalSoft_Poll_1_Q_FS']); $TotalSoft_Poll_1_LAQ_H = sanitize_text_field($_POST['TotalSoft_Poll_1_LAQ_H']); $TotalSoft_Poll_1_A_FS = sanitize_text_field($_POST['TotalSoft_Poll_1_A_FS']); $TotalSoft_Poll_1_A_CTF = sanitize_text_field($_POST['TotalSoft_Poll_1_A_CTF']); $TotalSoft_Poll_1_CH_S = sanitize_text_field($_POST['TotalSoft_Poll_1_CH_S']); $TotalSoft_Poll_1_LAA_H = sanitize_text_field($_POST['TotalSoft_Poll_1_LAA_H']); $TotalSoft_Poll_1_VB_BW = sanitize_text_field($_POST['TotalSoft_Poll_1_VB_BW']); $TotalSoft_Poll_1_VB_BR = sanitize_text_field($_POST['TotalSoft_Poll_1_VB_BR']); $TotalSoft_Poll_1_VB_FS = sanitize_text_field($_POST['TotalSoft_Poll_1_VB_FS']); $TotalSoft_Poll_1_VB_Text = str_replace("\&","&", sanitize_text_field(esc_html($_POST['TotalSoft_Poll_1_VB_Text']))); $TotalSoft_Poll_1_VB_IS = sanitize_text_field($_POST['TotalSoft_Poll_1_VB_IS']); $TotalSoft_Poll_1_RB_BW = sanitize_text_field($_POST['TotalSoft_Poll_1_RB_BW']); $TotalSoft_Poll_1_RB_BR = sanitize_text_field($_POST['TotalSoft_Poll_1_RB_BR']); $TotalSoft_Poll_1_RB_FS = sanitize_text_field($_POST['TotalSoft_Poll_1_RB_FS']); $TotalSoft_Poll_1_RB_Text = str_replace("\&","&", sanitize_text_field(esc_html($_POST['TotalSoft_Poll_1_RB_Text'])));
			...
			if(isset($_POST['Total_Soft_Poll_TUpdate']))
			{
				...
				{
					$wpdb->query($wpdb->prepare("UPDATE $table_name5 set TotalSoft_Poll_TTitle = %s, TotalSoft_Poll_TType = %s, TotalSoft_Poll_1_MW = %s, TotalSoft_Poll_1_BW = %s, TotalSoft_Poll_1_BR = %s, TotalSoft_Poll_1_Q_FS = %s, TotalSoft_Poll_1_LAQ_H = %s, TotalSoft_Poll_1_A_FS = %s, TotalSoft_Poll_1_A_CTF = %s, TotalSoft_Poll_1_CH_S = %s, TotalSoft_Poll_1_LAA_H = %s, TotalSoft_Poll_1_VB_BW = %s, TotalSoft_Poll_1_VB_BR = %s, TotalSoft_Poll_1_VB_FS = %s, TotalSoft_Poll_1_VB_Text = %s, TotalSoft_Poll_1_VB_IS = %s, TotalSoft_Poll_1_RB_BW = %s, TotalSoft_Poll_1_RB_BR = %s, TotalSoft_Poll_1_RB_FS = %s, TotalSoft_Poll_1_RB_Text = %s WHERE TotalSoft_Poll_TID=%s", $TotalSoft_Poll_TTitle, $TotalSoft_Poll_TType, $TotalSoft_Poll_1_MW, $TotalSoft_Poll_1_BW, $TotalSoft_Poll_1_BR, $TotalSoft_Poll_1_Q_FS, $TotalSoft_Poll_1_LAQ_H, $TotalSoft_Poll_1_A_FS, $TotalSoft_Poll_1_A_CTF, $TotalSoft_Poll_1_CH_S, $TotalSoft_Poll_1_LAA_H, $TotalSoft_Poll_1_VB_BW, $TotalSoft_Poll_1_VB_BR, $TotalSoft_Poll_1_VB_FS, $TotalSoft_Poll_1_VB_Text, $TotalSoft_Poll_1_VB_IS, $TotalSoft_Poll_1_RB_BW, $TotalSoft_Poll_1_RB_BR, $TotalSoft_Poll_1_RB_FS, $TotalSoft_Poll_1_RB_Text, $Total_SoftPoll_TUpdateID));
				...
				{
					$wpdb->query($wpdb->prepare("UPDATE $table_name9 set TotalSoft_Poll_TTitle = %s, TotalSoft_Poll_TType = %s, TotalSoft_Poll_2_MW = %s, TotalSoft_Poll_2_BW = %s, TotalSoft_Poll_2_BR = %s, TotalSoft_Poll_2_Q_FS = %s, TotalSoft_Poll_2_LAQ_H = %s, TotalSoft_Poll_2_A_CC = %s, TotalSoft_Poll_2_A_IH = %s, TotalSoft_Poll_2_A_FS = %s, TotalSoft_Poll_2_CH_S = %s, TotalSoft_Poll_2_LAA_H = %s, TotalSoft_Poll_2_VB_BW = %s, TotalSoft_Poll_2_Play_IS = %s WHERE TotalSoft_Poll_TID=%s", $TotalSoft_Poll_TTitle, $TotalSoft_Poll_TType, $TotalSoft_Poll_2_MW, $TotalSoft_Poll_2_BW, $TotalSoft_Poll_2_BR, $TotalSoft_Poll_2_Q_FS, $TotalSoft_Poll_2_LAQ_H, $TotalSoft_Poll_2_A_CC, $TotalSoft_Poll_2_A_IH, $TotalSoft_Poll_2_A_FS, $TotalSoft_Poll_2_CH_S, $TotalSoft_Poll_2_LAA_H, $TotalSoft_Poll_2_VB_BW, $TotalSoft_Poll_2_Play_IS, $Total_SoftPoll_TUpdateID));
					$wpdb->query($wpdb->prepare("UPDATE $table_name10 set TotalSoft_Poll_TTitle = %s, TotalSoft_Poll_TType = %s, TotalSoft_Poll_2_VB_BR = %s, TotalSoft_Poll_2_VB_FS = %s, TotalSoft_Poll_2_VB_Text = %s, TotalSoft_Poll_2_VB_IS = %s, TotalSoft_Poll_2_RB_BW = %s, TotalSoft_Poll_2_RB_BR = %s, TotalSoft_Poll_2_RB_FS = %s, TotalSoft_Poll_2_RB_Text = %s, TotalSoft_Poll_2_RB_IS = %s, TotalSoft_Poll_2_P_BB_Text = %s WHERE TotalSoft_Poll_TID=%s", $TotalSoft_Poll_TTitle, $TotalSoft_Poll_TType, $TotalSoft_Poll_2_VB_BR, $TotalSoft_Poll_2_VB_FS, $TotalSoft_Poll_2_VB_Text, $TotalSoft_Poll_2_VB_IS, $TotalSoft_Poll_2_RB_BW, $TotalSoft_Poll_2_RB_BR, $TotalSoft_Poll_2_RB_FS, $TotalSoft_Poll_2_RB_Text, $TotalSoft_Poll_2_RB_IS, $TotalSoft_Poll_2_P_BB_Text, $Total_SoftPoll_TUpdateID));
				}
				else if($TotalSoft_Poll_TType == 'Standart Without Button')
				{
					$wpdb->query($wpdb->prepare("UPDATE $table_name11 set TotalSoft_Poll_TTitle = %s, TotalSoft_Poll_TType = %s, TotalSoft_Poll_3_MW = %s, TotalSoft_Poll_3_BW = %s, TotalSoft_Poll_3_BR = %s, TotalSoft_Poll_3_Q_FS = %s, TotalSoft_Poll_3_LAQ_H = %s, TotalSoft_Poll_3_A_FS = %s, TotalSoft_Poll_3_A_BW = %s, TotalSoft_Poll_3_A_BR = %s, TotalSoft_Poll_3_CH_S = %s, TotalSoft_Poll_3_LAA_H = %s WHERE TotalSoft_Poll_TID=%s", $TotalSoft_Poll_TTitle, $TotalSoft_Poll_TType, $TotalSoft_Poll_3_MW, $TotalSoft_Poll_3_BW, $TotalSoft_Poll_3_BR, $TotalSoft_Poll_3_Q_FS, $TotalSoft_Poll_3_LAQ_H, $TotalSoft_Poll_3_A_FS, $TotalSoft_Poll_3_A_BW, $TotalSoft_Poll_3_A_BR, $TotalSoft_Poll_3_CH_S, $TotalSoft_Poll_3_LAA_H, $Total_SoftPoll_TUpdateID));
					$wpdb->query($wpdb->prepare("UPDATE $table_name12 set TotalSoft_Poll_TTitle = %s, TotalSoft_Poll_TType = %s, TotalSoft_Poll_3_TV_FS = %s, TotalSoft_Poll_3_TV_Text = %s, TotalSoft_Poll_3_RB_BW = %s, TotalSoft_Poll_3_RB_BR = %s, TotalSoft_Poll_3_RB_FS = %s, TotalSoft_Poll_3_RB_Text = %s, TotalSoft_Poll_3_RB_IS = %s, TotalSoft_Poll_3_BB_Text = %s WHERE TotalSoft_Poll_TID=%s", $TotalSoft_Poll_TTitle, $TotalSoft_Poll_TType, $TotalSoft_Poll_3_TV_FS, $TotalSoft_Poll_3_TV_Text, $TotalSoft_Poll_3_RB_BW, $TotalSoft_Poll_3_RB_BR, $TotalSoft_Poll_3_RB_FS, $TotalSoft_Poll_3_RB_Text, $TotalSoft_Poll_3_RB_IS, $TotalSoft_Poll_3_BB_Text, $Total_SoftPoll_TUpdateID));
				}
				else if($TotalSoft_Poll_TType == 'Image Without Button' || $TotalSoft_Poll_TType == 'Video Without Button')
				{
					$wpdb->query($wpdb->prepare("UPDATE $table_name13 set TotalSoft_Poll_TTitle = %s, TotalSoft_Poll_TType = %s, TotalSoft_Poll_4_MW = %s, TotalSoft_Poll_4_BW = %s, TotalSoft_Poll_4_BR = %s, TotalSoft_Poll_4_Q_FS = %s, TotalSoft_Poll_4_LAQ_H = %s, TotalSoft_Poll_4_A_FS = %s, TotalSoft_Poll_4_A_BW = %s, TotalSoft_Poll_4_A_BR = %s, TotalSoft_Poll_4_I_Ra = %s, TotalSoft_Poll_4_I_IS = %s, TotalSoft_Poll_4_Pop_BW = %s, TotalSoft_Poll_4_LAA_H = %s WHERE TotalSoft_Poll_TID=%s", $TotalSoft_Poll_TTitle, $TotalSoft_Poll_TType, $TotalSoft_Poll_4_MW, $TotalSoft_Poll_4_BW, $TotalSoft_Poll_4_BR, $TotalSoft_Poll_4_Q_FS, $TotalSoft_Poll_4_LAQ_H, $TotalSoft_Poll_4_A_FS, $TotalSoft_Poll_4_A_BW, $TotalSoft_Poll_4_A_BR, $TotalSoft_Poll_4_I_Ra, $TotalSoft_Poll_4_I_IS, $TotalSoft_Poll_4_Pop_BW, $TotalSoft_Poll_4_LAA_H, $Total_SoftPoll_TUpdateID));
					$wpdb->query($wpdb->prepare("UPDATE $table_name14 set TotalSoft_Poll_TTitle = %s, TotalSoft_Poll_TType = %s, TotalSoft_Poll_4_TV_FS = %s, TotalSoft_Poll_4_TV_Text = %s, TotalSoft_Poll_4_RB_BW = %s, TotalSoft_Poll_4_RB_BR = %s, TotalSoft_Poll_4_RB_FS = %s, TotalSoft_Poll_4_RB_Text = %s, TotalSoft_Poll_4_RB_IS = %s, TotalSoft_Poll_4_BB_Text = %s WHERE TotalSoft_Poll_TID=%s", $TotalSoft_Poll_TTitle, $TotalSoft_Poll_TType, $TotalSoft_Poll_4_TV_FS, $TotalSoft_Poll_4_TV_Text, $TotalSoft_Poll_4_RB_BW, $TotalSoft_Poll_4_RB_BR, $TotalSoft_Poll_4_RB_FS, $TotalSoft_Poll_4_RB_Text, $TotalSoft_Poll_4_RB_IS, $TotalSoft_Poll_4_BB_Text, $Total_SoftPoll_TUpdateID));
				}
				else if($TotalSoft_Poll_TType == 'Image in Question' || $TotalSoft_Poll_TType == 'Video in Question')
				{
					$wpdb->query($wpdb->prepare("UPDATE $table_name16 set TotalSoft_Poll_TTitle = %s, TotalSoft_Poll_TType = %s, TotalSoft_Poll_5_MW = %s, TotalSoft_Poll_5_BW = %s, TotalSoft_Poll_5_BR = %s, TotalSoft_Poll_5_Q_FS = %s, TotalSoft_Poll_5_I_Ra = %s, TotalSoft_Poll_5_LAQ_H = %s, TotalSoft_Poll_5_A_FS = %s, TotalSoft_Poll_5_A_BW = %s, TotalSoft_Poll_5_A_BR = %s, TotalSoft_Poll_5_CH_S = %s, TotalSoft_Poll_5_LAA_H = %s, TotalSoft_Poll_5_TV_FS = %s, TotalSoft_Poll_5_VB_BW = %s, TotalSoft_Poll_5_VB_BR = %s, TotalSoft_Poll_5_VB_FS = %s WHERE TotalSoft_Poll_TID=%s", $TotalSoft_Poll_TTitle, $TotalSoft_Poll_TType, $TotalSoft_Poll_5_MW, $TotalSoft_Poll_5_BW, $TotalSoft_Poll_5_BR, $TotalSoft_Poll_5_Q_FS, $TotalSoft_Poll_5_I_Ra, $TotalSoft_Poll_5_LAQ_H, $TotalSoft_Poll_5_A_FS, $TotalSoft_Poll_5_A_BW, $TotalSoft_Poll_5_A_BR, $TotalSoft_Poll_5_CH_S, $TotalSoft_Poll_5_LAA_H, $TotalSoft_Poll_5_TV_FS, $TotalSoft_Poll_5_VB_BW, $TotalSoft_Poll_5_VB_BR, $TotalSoft_Poll_5_VB_FS, $Total_SoftPoll_TUpdateID));
					$wpdb->query($wpdb->prepare("UPDATE $table_name17 set TotalSoft_Poll_TTitle = %s, TotalSoft_Poll_TType = %s, TotalSoft_Poll_5_VB_IS = %s, TotalSoft_Poll_5_RB_BW = %s, TotalSoft_Poll_5_RB_BR = %s, TotalSoft_Poll_5_RB_FS = %s, TotalSoft_Poll_5_RB_IS = %s, TotalSoft_Poll_5_TV_Text = %s, TotalSoft_Poll_5_BB_Text = %s, TotalSoft_Poll_5_RB_Text = %s, TotalSoft_Poll_5_VB_Text = %s WHERE TotalSoft_Poll_TID=%s", $TotalSoft_Poll_TTitle, $TotalSoft_Poll_TType, $TotalSoft_Poll_5_VB_IS, $TotalSoft_Poll_5_RB_BW, $TotalSoft_Poll_5_RB_BR, $TotalSoft_Poll_5_RB_FS, $TotalSoft_Poll_5_RB_IS, $TotalSoft_Poll_5_TV_Text, $TotalSoft_Poll_5_BB_Text, $TotalSoft_Poll_5_RB_Text, $TotalSoft_Poll_5_VB_Text, $Total_SoftPoll_TUpdateID));
				}
			}
		}
	    else
...
<form method="POST" oninput="TotalSoft_Poll_Out()">
	...
	<table class="Total_Soft_Poll_TMSetTable Total_Soft_Poll_TMSetTables Total_Soft_Poll_TMSetTable_1">
		...
		<tr>
			...
			<td>Box Shadow <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="Choose to show the box shadow or no."></i></td>
			<td>
				<div class="switch">
		...
		<tr>
			...
			<td>Shadow <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="Choose the shadow size for the poll."></i></td>
			<td>
		...
		<tr>
			...
			<td>Font Family <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="Select your preferable font family for question. Poll plugin has a fonts base."></i></td>
			<td>
		...
		<tr>
			<td>Font Family <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="Select that font family which will make your poll more beautiful."></i></td>
			<td>
	...
	<table class="Total_Soft_Poll_TMSetTable Total_Soft_Poll_TMSetTables Total_Soft_Poll_TMSetTable_3">
		...
		<tr>
			...
			<td>Shadow <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="Choose the shadow size for the Standart Without Button poll type."></i></td>
			<td>
		...
		<tr>
			...
			<td>Font Family <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="Select your preferable font family for question. Plugin has a fonts base."></i></td>
			<td>
	...
	<table class="Total_Soft_Poll_TMSetTable Total_Soft_Poll_TMSetTables Total_Soft_Poll_TMSetTable_4">
		...
		<tr>
			...
			<td>Shadow <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="Choose the shadow size for the social poll."></i></td>
			<td>
		...
		<tr>
			<td>Font Family <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="Select your preferable font family for answers."></i></td>
			<td>
	...
	<table class="Total_Soft_Poll_TMSetTable Total_Soft_Poll_TMSetTables Total_Soft_Poll_TMSetTable_5">
		...
		<tr>
			...
			<td>Font Family <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="Select that font family which will make your social poll more beautiful."></i></td>
			<td>
