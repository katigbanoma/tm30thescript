		...
		function form($instance)
 		...
 		function widget($args,$instance)
 		{
				...
				<?php } else if($Total_Soft_Poll_Themes[0]->TotalSoft_Poll_TType == 'Image Poll' || $Total_Soft_Poll_Themes[0]->TotalSoft_Poll_TType == 'Video Poll'){ ?>
					<style type="text/css">
						.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?>
						{
							...
							<?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxSh_Show == 'true'){ ?>
	    						<?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxSh_Type == 'true'){ ?> 
	    							-webkit-box-shadow: 0px 0px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxSh;?>px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxShC;?>;
	                                -moz-box-shadow: 0px 0px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxSh;?>px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxShC;?>;
	    							box-shadow: 0px 0px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxSh;?>px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxShC;?>;
	    						<?php }else{ ?>
	    							-webkit-box-shadow: 0 25px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxSh;?>px -18px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxShC;?>;
	    							-moz-box-shadow: 0 25px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxSh;?>px -18px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxShC;?>;
	    							box-shadow: 0 25px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxSh;?>px -18px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxShC;?>;
	    						<?php }?>
	    					<?php }?>
						}
						.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Quest_Div_<?php echo $Total_Soft_Poll;?>
						...
						.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_Ov_Lab_<?php echo $Total_Soft_Poll;?>
						{
							margin-top: 10%;
						}
						...
						{
							width: 100%;
							height: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_A_IH;?>px;
							margin: 0px;
						}
						.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Lab_<?php echo $Total_Soft_Poll;?>
						{
						...
						<?php if($Total_Soft_Poll_Themes[0]->TotalSoft_Poll_TType == 'Video Poll'){ ?> 
							.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_Play_Overlay_<?php echo $Total_Soft_Poll;?>
							{
								...
								position: absolute;
								left: 0 !important;
								<?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_A_Pos == 'Position 3' || $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_A_Pos == 'Position 4'){ ?> top: 0 !important; <?php }else{ ?> bottom: 3px !important; <?php }?>								
								width: 100% !important;
								height: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_A_IH+3;?>px;
								display: none;
								cursor: pointer;
							}
								...
								<div class="Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?>">
									<?php for($i = 0 ; $i < $Total_Soft_Poll_Man[0]->TotalSoftPoll_Ans_C; $i++){ 
										...
										<div class="Total_Soft_Poll_1_Ans_Check_Div" <?php if($Total_Soft_Poll_Themes[0]->TotalSoft_Poll_TType == 'Video Poll'){ ?> onmouseover = "Total_Soft_Poll_Video_Hove(<?php echo $Total_Soft_Poll;?>, <?php echo $i;?>)"  onmouseout = "Total_Soft_Poll_Video_Out(<?php echo $Total_Soft_Poll;?>, <?php echo $i;?>)" <?php }?>>
											...
											<div class="Total_Soft_Poll_1_Ans_Div_Overlay_<?php echo $Total_Soft_Poll;?>">
												<?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_P_A_VT == 'percentlab' || $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_P_A_VT == 'countlab' || $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_P_A_VT == 'bothlab'){ ?>
				...
				<?php } else if($Total_Soft_Poll_Themes[0]->TotalSoft_Poll_TType == 'Standart Without Button'){ ?>
					<style type="text/css">
						.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?>
						{
							...
							<?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxSh_Show == 'true'){ ?>
	    						<?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxSh_Type == 'true'){ ?> 
	    							-webkit-box-shadow: 0px 0px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxSh;?>px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxShC;?>;
	                                -moz-box-shadow: 0px 0px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxSh;?>px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxShC;?>;
	    							box-shadow: 0px 0px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxSh;?>px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxShC;?>;
	    						<?php }else{ ?>
	    							-webkit-box-shadow: 0 25px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxSh;?>px -18px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxShC;?>;
	    							-moz-box-shadow: 0 25px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxSh;?>px -18px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxShC;?>;
	    							box-shadow: 0 25px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxSh;?>px -18px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxShC;?>;
	    						<?php }?>
	    					<?php }?>
				...
				<?php } else if($Total_Soft_Poll_Themes[0]->TotalSoft_Poll_TType == 'Image Without Button' || $Total_Soft_Poll_Themes[0]->TotalSoft_Poll_TType == 'Video Without Button'){ ?>
					<style type="text/css">
						.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?>
						{
							...
							<?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxSh_Show == 'true'){ ?>
	    						<?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxSh_Type == 'true'){ ?> 
	    							-webkit-box-shadow: 0px 0px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxSh;?>px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxShC;?>;
	                                -moz-box-shadow: 0px 0px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxSh;?>px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxShC;?>;
	    							box-shadow: 0px 0px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxSh;?>px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxShC;?>;
	    						<?php }else{ ?>
	    							-webkit-box-shadow: 0 25px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxSh;?>px -18px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxShC;?>;
	    							-moz-box-shadow: 0 25px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxSh;?>px -18px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxShC;?>;
	    							box-shadow: 0 25px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxSh;?>px -18px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxShC;?>;
	    						<?php }?>
	    					<?php }?>
				...
				<?php } else if($Total_Soft_Poll_Themes[0]->TotalSoft_Poll_TType == 'Image in Question' || $Total_Soft_Poll_Themes[0]->TotalSoft_Poll_TType == 'Video in Question'){ ?>
					<style type="text/css">
						.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?>
						{
							...
							<?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxSh_Show == 'true'){ ?>
	    						<?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxSh_Type == 'true'){ ?> 
	    							-webkit-box-shadow: 0px 0px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxSh;?>px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxShC;?>;
	                                -moz-box-shadow: 0px 0px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxSh;?>px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxShC;?>;
	    							box-shadow: 0px 0px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxSh;?>px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxShC;?>;
	    						<?php }else{ ?>
	    							-webkit-box-shadow: 0 25px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxSh;?>px -18px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxShC;?>;
	    							-moz-box-shadow: 0 25px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxSh;?>px -18px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxShC;?>;
	    							box-shadow: 0 25px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxSh;?>px -18px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxShC;?>;
	    						<?php }?>
	    					<?php }?>
						...
						.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Quest_Div_<?php echo $Total_Soft_Poll;?> img
						{
							...
							<?php }?>
							height: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_I_H;?>px;
						}	
						.Total_Soft_Poll_1_Q_Iframe_1_<?php echo $Total_Soft_Poll;?>
						{
							position: relative;
			...
			if(isset($_COOKIE['TotalSoft_Poll_Cookie_' . $Total_Soft_Poll])) 
			{
			    if( $_COOKIE['TotalSoft_Poll_Cookie_' . $Total_Soft_Poll] == 'Standart' )
				{
					?>
				    	<script type="text/javascript">
				    		Total_Soft_Poll_Ans_Div1(<?php echo $Total_Soft_Poll;?>);
				    	</script>
				    <?php
				}
				else if( $_COOKIE['TotalSoft_Poll_Cookie_' . $Total_Soft_Poll] == 'Image/Video' )
				{
					?>
				    	<script type="text/javascript">
				...
				else if( $_COOKIE['TotalSoft_Poll_Cookie_' . $Total_Soft_Poll] == 'StandartWB' )
				{
					?>
				    	<script type="text/javascript">
				...
				else if( $_COOKIE['TotalSoft_Poll_Cookie_' . $Total_Soft_Poll] == 'ImageWB/VideoWB' )
				{
					?>
				    	<script type="text/javascript">
				...
				else if( $_COOKIE['TotalSoft_Poll_Cookie_' . $Total_Soft_Poll] == 'ImageIQ/VideoIQ' )
				{
					?>
				    	<script type="text/javascript">
				    		Total_Soft_Poll_Ans_DivSt1(<?php echo $Total_Soft_Poll;?>);
